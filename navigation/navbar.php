        ...
        <a class="navbar-brand" href="../accueil/accueil.php">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item mx-3">
                        <a class="nav-link" href="../cours/noscours.php">Nos Cours</a>
                    </li>
                    <li class="nav-item mx-3">
            ...
            <div class="d-flex me-5">
                <?php 
                    ...
                    if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] === true) {
                        ...
                        echo '<a href="../connection/logout.php"><button class="btn btn-blue rounded-pill">Déconnexion</button></a>';
                    } else {
                        // If not logged in  display login and signup buttons
                        echo '<a href="../connection/connection.php"><button class="btn">Se connecter</button></a>';
                        echo '<a href="../inscription/inscription.php"><button class="btn btn-blue rounded-pill">S\'inscrire</button></a>';
                    }
                ?>
            </div>
        </div>
