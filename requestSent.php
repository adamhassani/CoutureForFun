                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-xl-6 d-flex align-items-center py-0 my-0">
                                <div class="card-body p-md-3 p-xl-5 text-black">
                                    ...
                                    <h1 class="mb-0">Demande envoyee</h1>
                                    <p class="mb-4 text-muted">Demande envoyee vous pouvez revenir a la page d'accueil.</p>

                                    <div class="d-flex justify-content-end pt-3 mb-0">
                                        <a href = "accueil.php">
                                            <button type="submit" class="btn btn-blue btn-block w-100 rounded-pill" name="envoyer-inscriptioncours">Vers l'accueil</button>
                                        </a>
                                    </div> 
